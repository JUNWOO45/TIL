...
- ###애자일과 데브옵스를 방해하는 Blockers, 그리고 블로커스를 극복하기위한 company, team, individual의 역할
  ...
  - 조직 & KPI
    ...
    - 아직도 복지부동, 장애시간, 장애횟수로 KPI를 평가합니까
      - 장애 생겨도 돼요. 장애를 얼마나 빨리 해결, 그로인한 배포.
      - best practice를 공유하고 좋은 방법을 찾는 것. 이게 KPI에 더 죠음.
    - 회사 :
      - Matrix 구성 및 평가
      - SCM/issue 툴 통한 정량 평가( open, merge한 횟수를 정량 평가)
      - 별동조직 도입
        - 누군가 좋은 툴을 쓴다걱나, 좋은 습관을 가지고 있는 것을 찾는 별동대.
    - 팀 :
...
### "왜 이렇게 까지 고급개발자들이 수많은 프로느엔드 기술들을 죽어라고 공부할까요?"

- 웹 어플리케이션의 활용 범위가 다양해지기 때문.
  - 모바일에서 네이티브앱을 웹앱으로 대체 : react native
  - 네이티브 앱같이 느껴지는 웹앱 : PWA
  - 데스크탑에서 웹 앱을 설치 : electron (예를 들어 slack이 있음.)
...
- 사용자 인터페이스
  ...
  - NO dom keyboardEvent,  mouseEvent
